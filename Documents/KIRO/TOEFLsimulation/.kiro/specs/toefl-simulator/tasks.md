...
- [x] 13. Implement Zustand stores with persistence
  - [x] 13.1 Create `examStore` with persist middleware
  ...
  - [x] 13.2 Create `timerStore` with server sync
  ...
  - [x] 13.3 Create `abilityStore` for IRT parameters
  ...
  - [x] 13.4 Create `uiStore` for UI state
  ...
  - [x] 13.5 Write unit tests for Zustand stores
...
- [x] 14. Implement core layout components
  - [x] 14.1 Create `ExamShell` top-level container
  ...
  - [x] 14.3 Write unit tests for Header component
    - Test timer display updates correctly
    - Test button click handlers
    - Test accessibility (ARIA labels, keyboard navigation)
    - _Requirements: 10.1, 23.1, 23.2_

- [x] 15. Implement navigation and review modal
  - [x] 15.1 Create `ReviewModal` component
  ...
  - [x] 15.2 Write property test for navigation module boundary enforcement
  ...
  - [x] 15.3 Write unit tests for ReviewModal
...
- [x] 16. Implement Reading section components
  - [x] 16.1 Create `PassageViewer` component with split-screen layout
  ...
  - [x] 16.2 Implement Gatekeeper logic in PassageViewer
  ...
  - [x] 16.3 Write property test for gatekeeper lock-unlock behavior
  ...
  - [x] 16.4 Create `QuestionDisplay` component for reading questions
  ...
  - [x] 16.5 Write unit tests for Reading section components
...
- [x] 17. Implement Listening section components
  - [x] 17.1 Create `AudioPlayer` component
  ...
  - [x] 17.2 Create `QuestionDisplay` variant for listening questions
  ...
  - [x] 17.3 Write unit tests for Listening section components
